...
function sortData() {
    // Sort the dataset in ascending or descending order based on the current state
    dataset.sort((a, b) => sortAscending ? a - b : b - a);
    sortAscending = !sortAscending; // Toggle sort direction for the next click
...
// Add a sort button event listener
